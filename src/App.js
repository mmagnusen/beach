...
class App extends Component {
  ...
  filteredDeals = () => {
    ...
    return filter.dates.chosenDate === 'All dates' ? filteredByAirport : filteredByAirport.filter((deal) => deal.date === filter.dates.chosenDate);
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        <section className='Holidays' style={{ backgroundImage: `url(${background})`, backgroundSize: 'contain'}}>
          <main>
            <section>
              <Sort options={sort.options} activeSort={sort.activeSort} sortBy={this.sortBy} />
              <Filter airports={filter.airports} filterAirport={this.filterAirport} dates={filter.dates} filterDate={this.filterDate} reset={this.resetFilters}/>
            </section>
